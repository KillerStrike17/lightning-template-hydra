...
class DogBreedImageDataModule(L.LightningDataModule):
    ...
    def prepare_data(self):
        ...
        output = Path(self._dl_path).joinpath("dog_breeds.zip")
        ...
        # Rename 'dataset' folder to 'dog_breeds'
        extracted_folder = Path(self._dl_path).joinpath("dataset")
